...
NODE_CLASS_MAPPINGS = {
    "UmiAI - Advanced Prompt Generation": UmiTextGen,
    "UmiAI - Random Line Selection": RandomLineSelection
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "UmiAI - Advanced Prompt Generation": "Advanced Prompt Generation",
    "UmiAI - Random Line Selection": "Random Line Selection"
}
